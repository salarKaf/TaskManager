...
@router.post("/CreateProjects", response_model=ProjectDisplay)
...
@router.get("/GetProjects", response_model=List[ProjectDisplay])
...
@router.post("/GetALLTask" , response_model=List[TaskDisplay])
